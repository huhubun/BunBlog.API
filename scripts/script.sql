...
BEGIN
    ...
    VALUES ('20190804135514_Init', '5.0.2');
    END IF;
END $$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20190908103307_MadePostLinkNameRequired') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20190908103307_MadePostLinkNameRequired', '5.0.2');
    END IF;
END $$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20190914062023_AddImageTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20190914062023_AddImageTable', '5.0.2');
    END IF;
END $$;
COMMIT;
...
BEGIN
    ...
    PERFORM * FROM setval('"Tag_Id_seq"', nextval('"Tag_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM * FROM setval('"Post_Id_seq"', nextval('"Post_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM * FROM setval('"Image_Id_seq"', nextval('"Image_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM * FROM setval('"Category_Id_seq"', nextval('"Category_Id_old_seq"'), false);
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20191206025734_AddPostTypeToBlogPostTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20191206025734_AddPostTypeToBlogPostTable', '5.0.2');
    END IF;
END $$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20200218174248_AddSettingTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20200218174248_AddSettingTable', '5.0.2');
    END IF;
END $$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20200220161758_AddSiteLinkTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20200220161758_AddSiteLinkTable', '5.0.2');
    END IF;
END $$;
COMMIT;
...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20210116145525_PostAddFor') THEN
    ALTER TABLE "Post" ADD "For" integer NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20210116145525_PostAddFor') THEN
    ALTER TABLE "Post" ADD "LastModifyOn" timestamp without time zone NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20210116145525_PostAddFor') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210116145525_PostAddFor', '5.0.2');
    END IF;
END $$;
COMMIT;
...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20210130161128_AddPostStyling') THEN
    ALTER TABLE "Post" ADD "Styling" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20210130161128_AddPostStyling') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210130161128_AddPostStyling', '5.0.2');
    END IF;
END $$;
COMMIT;
