...
BEGIN
    ...
    VALUES ('20190804135514_Init', '3.1.0');
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20190908103307_MadePostLinkNameRequired') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20190908103307_MadePostLinkNameRequired', '3.1.0');
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20190914062023_AddImageTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20190914062023_AddImageTable', '3.1.0');
    END IF;
END $$;
...
BEGIN
    ...
    PERFORM setval('"Tag_Id_seq"', nextval('"Tag_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM setval('"Post_Id_seq"', nextval('"Post_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM setval('"Image_Id_seq"', nextval('"Image_Id_old_seq"'), false);
...
BEGIN
    ...
    PERFORM setval('"Category_Id_seq"', nextval('"Category_Id_old_seq"'), false);
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "MigrationHistory" WHERE "MigrationId" = '20191206025734_AddPostTypeToBlogPostTable') THEN
    INSERT INTO "MigrationHistory" ("MigrationId", "ProductVersion")
    VALUES ('20191206025734_AddPostTypeToBlogPostTable', '3.1.0');
    END IF;
END $$;
